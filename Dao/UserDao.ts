...
export class UserDao extends BaseDao {
  ...
  public searchUserByEmailOrPhone(email: string | null, phone: string | null,id_user:string) {
    return new Promise<(Omit<User, "password"> & {friend_status:FRIEND_STATUS})[]>((resolve, reject) => {
      this.db.query(
        `
