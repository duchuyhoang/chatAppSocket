...
const socketManager = (io, decodeData) => {
    ...
    exports.socketList[constants_1.SOCKET_NAMESPACE.NOTIFICATION] = io
        ...
        .use((0, authenticate_1.bindSocketData)(decodeData));
    exports.socketList[constants_1.SOCKET_NAMESPACE.CALL] = io.of(constants_1.SOCKET_NAMESPACE.CALL);
    ...
    (0, CallSocket_1.CallSocket)(exports.socketList[constants_1.SOCKET_NAMESPACE.CALL]);
    // Initial action here
