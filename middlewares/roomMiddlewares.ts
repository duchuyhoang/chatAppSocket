...
import {iconFolder,imageFolder,serverAddress,HOST_NAME} from "../common/constants";
import {randomId,getExtension} from "../common/functions";
import {IconCreateRequest,IconInfo} from "../TS/File";
import fs from 'fs';
import path from 'path';

function handleRenameIconFile(req:Request,file:Express.Multer.File):IconInfo {
...
const handleChangeIconName = (req:IconCreateRequest,res:Response,next:NextFunction) => {
